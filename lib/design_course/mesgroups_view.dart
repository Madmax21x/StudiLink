                                          ...
                                          children: <Widget>[
                                            Padding(
                                              padding: EdgeInsets.only(
                                                  top: 16, bottom: MediaQuery.of(context).size.height > 700 ? 25 : 10,),
                                              child: Text(
                                              newdata[index].title,
                                                ...
                                                children: <Widget>[
                                                  Text(
                                                    ...
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.w200,
                                                      fontSize: MediaQuery.of(context).size.height > 700 ? 14 : 10,
                                                      letterSpacing: 0.27,
                                                      color:
                                                  ...
                                                  Container(
                                                    ...
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.w600,
                                                      fontSize: MediaQuery.of(context).size.height > 700 ? 17 : 14,
                                                      letterSpacing: 0.27,
                                                      color:
                                                          DesignCourseAppTheme
                                                              .grey,
                                                ...
                                                children: <Widget>[
                                                  Text(
                                                    ...
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.w600,
                                                      fontSize: MediaQuery.of(context).size.height > 700 ? 17 : 12,
                                                      letterSpacing: 0.27,
                                                      color:
                                                          DesignCourseAppTheme
                                                              .nearlyBlue,
